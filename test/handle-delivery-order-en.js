        ...
        describe("Correct order", function(){
            it("will be processed.", function(){
                ...
                return emu.clear_context(user_id).then(function(){
                    ...
                    context.previous.message[0].message.text.should.equal("I love you. Then I will deliver the pine to 1-1-1, Minami Aoyama, Minatoku, Tokyo in about 30 minutes.")
                });
            });
        });
    });
